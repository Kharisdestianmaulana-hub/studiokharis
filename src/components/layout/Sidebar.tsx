...
export function Sidebar({ profileData }: { profileData?: any }) {
  ...
  return (
    <aside className={cn(
      "hidden lg:flex flex-col shrink-0 h-screen sticky top-0 border-r border-border bg-[#FAFAFA]/50 dark:bg-[#09090B]/50 backdrop-blur-xl z-30 transition-all duration-300",
