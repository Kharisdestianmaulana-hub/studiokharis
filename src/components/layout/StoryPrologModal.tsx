...
export function StoryPrologModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md animate-in fade-in duration-700">
      <div className="bg-surface/80 border border-border rounded-2xl p-8 max-w-lg w-[90%] shadow-2xl backdrop-blur-xl animate-in zoom-in-95 duration-500 delay-300 fill-mode-both">
